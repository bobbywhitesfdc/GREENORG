    ...
    getWorkDetails : function(component) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                //We do the following so that we can replace the namespace agf__ from the properties with a ''. So for ex: tasks[0].agf__Subject__c becomes tasks[0].Subject__c
