    ...
    getAssignmentRuleSelections : function(component, recordType) {
        ...
        action.setCallback(this, function(actionResult) {
            ...
            if(component.isValid() && state === "SUCCESS") {
                ...
                var createAssignmentRuleComponentName = 'agf:ADM_AssignmentRuleCreate'
                /* TODO: The agf:ADM_AssignmentRuleCreateInvestigation component is a duplicate of ADM_AssignmentRuleCreate but 
                ...
                */
                if(recordType === 'Investigation') {
                    createAssignmentRuleComponentName = 'agf:ADM_AssignmentRuleCreateInvestigation'
                }   
